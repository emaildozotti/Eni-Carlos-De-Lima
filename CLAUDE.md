...
Repositorio standalone da landing page de Eni Lima.
...
- **Cliente:** Eni Lima
- **GitHub:** https://github.com/emaildozotti/Eni-Carlos-De-Lima
- **Vercel:** https://eni-lima.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Eni Lima ao ar"
...
- O remote `origin` = `emaildozotti/Eni-Carlos-De-Lima` -- nao alterar
